        ...
        <Page size={"A4"} style={styles.body}>
          <View style={styles.container}>
            ...
            <Text style={styles.paragraph}>
              Incheiat astazi, [Data incheierii contractului], intre angajatorul
              Tema PSI, cu sediul in UVT si codul fiscal CUI300667, reprezentat
              de Otniel Didraga in calitate de angajator, si salariatul{" "}
              {user.nume} {user.prenume}, CNP {user.cnp}, domiciliat in [Adresa
              salariatului], in calitate de salariat.
            </Text>
            <Text style={styles.sectionTitle}>
              Articolul 1. Obiectul contractului
            </Text>
            <Text style={styles.paragraph}>
              Angajatorul angajeaza salariatul in calitate de CEO in
              conformitate cu prevederile legislatiei muncii si ale prezentului
              contract.
            </Text>
            <Text style={styles.sectionTitle}>
            ...
            <Text style={styles.paragraph}>
              ...
              nedeterminata, incepand cu data de [Data inceperii contractului].
            </Text>
            <Text style={styles.sectionTitle}>
              Articolul 3. Conditii de munca
            </Text>
            <Text style={styles.paragraph}>
              Salariul de incadrare al salariatului va fi in conformitate cu
              grila de salarizare stabilita de angajator si va fi platit lunar,
              in lei, prin Transfer bancar.
            </Text>
            <Text style={styles.sectionTitle}>
            ...
            <Text style={styles.paragraph}>
              ...
              prezentului contract se vor solutiona pe cale amiabila. In cazul
              in care nu se poate ajunge la un acord, litigiul va fi solutionat
              in instanta de judecata competenta.
            </Text>
          </View>
        </Page>
      ))}
